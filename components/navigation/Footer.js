const Footer = () => {
  return (
    <div className="flex justify-around px-24 pt-24 pb-48 flex-col md:flex-row">
        ...
        <div className="flex flex-col">
          ...
          <fieldset className="border border-secondary bg-opacity-0 w-full sm:w-auto">
            <input placeholder="Your Email" style={{ background: 'transparent' }} className="outline-none text-secondary px-5 py-2"/>
            <button className="px-3 py-3 mx-1 my-1 bg-secondary font-semibold text-lg sm:px-2">Subscribe</button>
          </fieldset>
        </div>
    </div>
  )
